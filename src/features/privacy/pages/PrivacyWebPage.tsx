        ...
        <div className="px-0 py-2 space-y-4 text-sm text-white/70" style={{ textAlign: 'justify' }}>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>
                <span className="font-medium">No account, no server:</span> The web build does not
                use login or cloud sync. We do not store your data on our servers.
              </li>
              <li>
                <span className="font-medium">Local device data only:</span> Your mood entries
                (emojis, optional colors, optional song title/artist), recent emoji list, and basic
                preferences (e.g., UI settings) are saved in your browser’s local storage.
              </li>
              <li>
                <span className="font-medium">No analytics:</span> We do not run analytics or
                tracking on the open web build.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>
                All data stays on your device and is used only to show your entries and preferences.
              </li>
              <li>
                Nothing is sent to our servers unless you explicitly export and share the file
                yourself.
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="mt-2">
              We do not sell or share your data. Because the web build is local-only, there is
              nothing for us to access on our side.
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="list-disc pl-5 mt-2">
              <li>
                Export your entries to a JSON file and import them later or on another browser.
              </li>
              <li>Clear local data in Settings if you want to wipe everything from this device.</li>
              <li>
                Using Flowday in Telegram? That version also keeps everything local and provides the
                same manual JSON export/import tools.
              </li>
            </ul>
          </div>
