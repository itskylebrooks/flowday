...
export default function ConstellationsPage({ entries, yearKey }: { entries: Entry[]; yearKey?: string }) {
  ...
  return (
    <div
      className="flex h-full flex-col items-center gap-5 select-none"
      style={{overflow:'hidden', touchAction:'none'}}
    >
      <div className="text-sm uppercase tracking-[0.4em] text-white/45">Emoji constellations</div>
      <div
        id={instructionsId}
        className="px-6 text-center text-xs text-white/60"
      >
        Drag the sky to explore. Move the window if it blocks another view.
      </div>
            ...
            >
              ...
              <div className="min-w-0">
                ...
                <div className="fd-constellation-window__subtitle">
                  Drag here to reposition. Double-tap or press Enter to center.
                </div>
              </div>
            </div>
            <button
